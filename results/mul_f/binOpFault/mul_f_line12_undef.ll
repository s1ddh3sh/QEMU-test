...
entry:
  ...
  %mul23 = mul i8 %4, %b, !dbg !148
    #dbg_value(i8 undef, !140, !DIExpression(), !135)
    #dbg_value(i8 undef, !149, !DIExpression(DW_OP_constu, 18446744073709551600, DW_OP_and, DW_OP_stack_value), !135)
  %5 = lshr i8 undef, 4, !dbg !150
  %6 = lshr i8 undef, 3, !dbg !151
  %7 = and i8 %6, 14, !dbg !151
  %8 = xor i8 %5, %7, !dbg !152
  %xor25.masked = and i8 undef, 15, !dbg !153
