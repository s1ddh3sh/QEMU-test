...
define dso_local void @mayo_memset(ptr noundef %dst, i8 noundef zeroext %val, i32 noundef %len) local_unnamed_addr #2 !dbg !165 {
entry:
    #dbg_value(ptr %dst, !169, !DIExpression(), !170)
    #dbg_value(i8 %val, !171, !DIExpression(), !170)
    #dbg_value(i32 %len, !172, !DIExpression(), !170)
    #dbg_value(ptr %dst, !173, !DIExpression(), !170)
    #dbg_value(i32 0, !174, !DIExpression(), !176)
  br label %for.cond, !dbg !177

for.cond:                                         ; preds = %for.body, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.body ], !dbg !178
    #dbg_value(i32 %i.0, !174, !DIExpression(), !176)
  %exitcond = icmp ne i32 %i.0, %len, !dbg !179
  br i1 %exitcond, label %for.body, label %for.end, !dbg !181

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i8, ptr %dst, i32 %i.0, !dbg !182
  store i8 %val, ptr %arrayidx, align 1, !dbg !183
  %inc = add i32 %i.0, 1, !dbg !184
    #dbg_value(i32 %inc, !174, !DIExpression(), !176)
...
; Function Attrs: nounwind
define dso_local void @mayo_memcpy(ptr noundef %dst, ptr noundef %src, i32 noundef %len) local_unnamed_addr #2 !dbg !190 {
entry:
    #dbg_value(ptr %dst, !195, !DIExpression(), !196)
    #dbg_value(ptr %src, !197, !DIExpression(), !196)
    #dbg_value(i32 %len, !198, !DIExpression(), !196)
    #dbg_value(ptr %dst, !199, !DIExpression(), !196)
    #dbg_value(ptr %src, !200, !DIExpression(), !196)
    #dbg_value(i32 0, !203, !DIExpression(), !205)
  br label %for.cond, !dbg !206

for.cond:                                         ; preds = %for.body, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.body ], !dbg !207
    #dbg_value(i32 %i.0, !203, !DIExpression(), !205)
  %exitcond = icmp ne i32 %i.0, %len, !dbg !208
  br i1 %exitcond, label %for.body, label %for.end, !dbg !210

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i8, ptr %src, i32 %i.0, !dbg !211
  %0 = load i8, ptr %arrayidx, align 1, !dbg !211
  %arrayidx1 = getelementptr inbounds nuw i8, ptr %dst, i32 %i.0, !dbg !212
  store i8 %0, ptr %arrayidx1, align 1, !dbg !213
  %inc = add i32 %i.0, 1, !dbg !214
    #dbg_value(i32 %inc, !203, !DIExpression(), !205)
...
!165 = distinct !DISubprogram(name: "mayo_memset", scope: !166, file: !166, line: 3, type: !167, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !123, retainedNodes: !36)
!166 = !DIFile(filename: "../mem.c", directory: "/home/siddhesh/Desktop/MAYO-LLVM/llvm-apps/mayo_pass/build")
!167 = !DISubroutineType(types: !168)
!168 = !{null, !70, !13, !20}
!169 = !DILocalVariable(name: "dst", arg: 1, scope: !165, file: !166, line: 3, type: !70)
!170 = !DILocation(line: 0, scope: !165)
!171 = !DILocalVariable(name: "val", arg: 2, scope: !165, file: !166, line: 3, type: !13)
!172 = !DILocalVariable(name: "len", arg: 3, scope: !165, file: !166, line: 3, type: !20)
!173 = !DILocalVariable(name: "d", scope: !165, file: !166, line: 5, type: !12)
!174 = !DILocalVariable(name: "i", scope: !175, file: !166, line: 7, type: !20)
!175 = distinct !DILexicalBlock(scope: !165, file: !166, line: 7, column: 5)
!176 = !DILocation(line: 0, scope: !175)
!177 = !DILocation(line: 7, column: 10, scope: !175)
!178 = !DILocation(line: 7, scope: !175)
!179 = !DILocation(line: 7, column: 28, scope: !180)
!180 = distinct !DILexicalBlock(scope: !175, file: !166, line: 7, column: 5)
!181 = !DILocation(line: 7, column: 5, scope: !175)
!182 = !DILocation(line: 8, column: 9, scope: !180)
!183 = !DILocation(line: 8, column: 14, scope: !180)
!184 = !DILocation(line: 7, column: 36, scope: !180)
!185 = !DILocation(line: 7, column: 5, scope: !180)
!186 = distinct !{!186, !181, !187, !188}
!187 = !DILocation(line: 8, column: 16, scope: !175)
!188 = !{!"llvm.loop.mustprogress"}
!189 = !DILocation(line: 9, column: 1, scope: !165)
!190 = distinct !DISubprogram(name: "mayo_memcpy", scope: !166, file: !166, line: 11, type: !191, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !124, retainedNodes: !36)
...
!195 = !DILocalVariable(name: "dst", arg: 1, scope: !190, file: !166, line: 11, type: !70)
!196 = !DILocation(line: 0, scope: !190)
!197 = !DILocalVariable(name: "src", arg: 2, scope: !190, file: !166, line: 11, type: !193)
!198 = !DILocalVariable(name: "len", arg: 3, scope: !190, file: !166, line: 11, type: !20)
!199 = !DILocalVariable(name: "d", scope: !190, file: !166, line: 13, type: !12)
!200 = !DILocalVariable(name: "s", scope: !190, file: !166, line: 14, type: !201)
!201 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !202, size: 32)
!202 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !13)
!203 = !DILocalVariable(name: "i", scope: !204, file: !166, line: 16, type: !20)
!204 = distinct !DILexicalBlock(scope: !190, file: !166, line: 16, column: 5)
!205 = !DILocation(line: 0, scope: !204)
!206 = !DILocation(line: 16, column: 10, scope: !204)
!207 = !DILocation(line: 16, scope: !204)
!208 = !DILocation(line: 16, column: 28, scope: !209)
!209 = distinct !DILexicalBlock(scope: !204, file: !166, line: 16, column: 5)
!210 = !DILocation(line: 16, column: 5, scope: !204)
!211 = !DILocation(line: 17, column: 16, scope: !209)
!212 = !DILocation(line: 17, column: 9, scope: !209)
!213 = !DILocation(line: 17, column: 14, scope: !209)
!214 = !DILocation(line: 16, column: 36, scope: !209)
!215 = !DILocation(line: 16, column: 5, scope: !209)
!216 = distinct !{!216, !210, !217, !188}
!217 = !DILocation(line: 17, column: 19, scope: !204)
!218 = !DILocation(line: 18, column: 1, scope: !190)
